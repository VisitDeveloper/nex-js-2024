      ...
      <div className="h-full flex flex-col xl:flex-row gap-16 items-stretch w-full max-w-screen-xl">
        ...
        <div className="basis-full lg:basis-1/2 flex flex-grow items-start flex-shrink-0 flex-col justify-center gap-8">
          <h5 className="font-bold text-5xl">
            BrainWave Learning - Smart, Fun, and Accessible
          </h5>

          <p className="">
            Every child deserves a fun and personalized learning journey. At
            BrainWave, we create interactive app books and dyslexia-friendly
          ...
          <ul className="flex flex-col w-full gap-2">
            <li className="flex items-start gap-2">
              ...
              <span>Innovative Apps for Young Learners</span>
            </li>
            <li className="flex items-start gap-2">
              <svg
                className="size-6"
              ...
              <span>Boost Early Literacy & Confidence</span>
            </li>
            <li className="flex items-start gap-2">
              <svg
                className="size-6"
              ...
              <span>Designed for All Learning Styles</span>
            </li>
          </ul>
