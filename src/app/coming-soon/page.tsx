        ...
        <div className="min-h-screen bg-gray-50 flex flex-col items-center p-8">
            ...
            <section className="mb-12 w-full max-w-2xl">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <img src="iMan.jpg" alt="pic1" className="rounded-lg shadow" />
                </div>
            </section>
