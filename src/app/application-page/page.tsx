...
export default function Application() {
  ...
  return (
    <div className=' mt-[100px] mb-20 '>
      <form className='mb-10 mx-10 flex flex-col sm:flex-row gap-2 items-center bg-miniBackground rounded-3xl  p-4 shadow-lg'>
      ...
      </form>
      {
        listOrCardActivate === true ?
          <>
            <Row className='gap-4 lg:justify-start lg:items-start justify-center items-center mx-10'>
              <div className='md:col-span-6 col-span-12 bg-miniBackground rounded-3xl shadow-lg min-h-[100px]'>
                <div className='flex flex-row gap-2 '>
                  <Image src={'/2.jpeg'} alt='picture' width={224} height={224} className='rounded-tl-3xl rounded-bl-3xl lg:size-56 size-36' />
              ...
              <div className='md:col-span-6 col-span-12 bg-miniBackground rounded-3xl shadow-lg min-h-[100px]'>
                <div className='flex flex-row gap-2 '>
                  <Image src={'/coffee.jpg'} alt='picture' width={224} height={224} className='rounded-tl-3xl rounded-bl-3xl lg:size-56 size-36' />
                  ...
                  <>
                    <div className='bg-miniBackground shadow-lg rounded-3xl w-full sm:w-48 md:w-56 h-[250px] flex flex-col p-4'>
                      <div className='avatar'>
                        <Image width={56} height={56} className="size-14 rounded" src={'/2.jpeg'} alt="Medium avatar" />
